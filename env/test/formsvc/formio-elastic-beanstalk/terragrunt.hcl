...
inputs = {
  name_prefix = "${local.name_prefix}-tf-submission-svr"
  ...
  app_version_bucket      = "faas-test-formsvc-submission-formio-bucket"
  app_version_source      = "sub-svr-v8-0-0-m-17.zip"
