...
terraform {
  source = "git::https://github.com/18F/formservice-iac-modules.git//elastic-beanstalk-app?ref=test"
}
...
inputs = {
  ...
  code_version     = "formio-submission/formio-submission-multicontainer-0.4.zip"
  code_version_id  = "v1"
