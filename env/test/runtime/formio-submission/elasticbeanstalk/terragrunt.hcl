...
inputs = {
  ...
  version_name = "faas-test-runtime-submission-app-v9.0.33-nginx-1.22.0-alpine-nonroot-user"

  ssl_cert = "arn:aws-us-gov:acm:us-gov-west-1:306851503416:certificate/ead863e9-532d-4f6d-ba54-797006feea2d"
