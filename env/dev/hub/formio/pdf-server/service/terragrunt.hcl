...
terraform {
  source = "git::https://github.com/18F/formservice-iac-modules.git//formio-pdf-task-def?ref=dev"
}
...
inputs = {
  ...
  task_secrets           = "faas-dev-hub-formio-pdf-secrets"
  aws_region             = "us-gov-west-1"
  log_stream_prefix      = "pdf"

  pdf_task_cpu          = 1024
  pdf_task_memory       = 3072
  pdf_image             = "306811362825.dkr.ecr.us-gov-west-1.amazonaws.com/formio/pdf-server:5.0.0"
