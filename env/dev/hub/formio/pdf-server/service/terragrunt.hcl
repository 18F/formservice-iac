...
inputs = {
  ...
  pdf_image             = "306811362825.dkr.ecr.us-gov-west-1.amazonaws.com/formio/pdf-server:3.3.6"
  ...
  service_security_group            = [dependency.formio-security.outputs.formio_ecs_pdf_sg]
