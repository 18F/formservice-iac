...
terraform {
  source = "git::https://github.com/18F/formservice-iac-modules.git//elastic-beanstalk?ref=dev"
}
...
inputs = {
  ...
  version_name = "faas-dev-hub-formio-app-v7.3.3-nginx:1.22.0-alpine-nonroot-user"
