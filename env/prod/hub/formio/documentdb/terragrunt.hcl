...
terraform {
  source = "git@github.com-gsa:18F/formservice-iac-modules.git//documentdb"
}
...
inputs = {
  ...
  cluster_size            = 3
  master_username         = "FAAS" #get_env("TF_VAR_master_username")
  master_password         = "3Gw2F2Wlqp4579NZ" #get_env("TF_VAR_master_password")
