...
inputs = {
  ...
  task_secrets           = "faas-prod-hub-formio-omb-enterprise-secrets"
  ...
  health_check_grace_period_seconds = 120 // set this to 300 (5 minutes) when creating a new tenant; this allows enough time to properly create the database schema
