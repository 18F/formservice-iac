...
dependencies      { paths = [ "../../../../../../dev/hub/vpc" ] }
dependency "vpc"  { config_path = "../../../../../../dev/hub/vpc" }
...
inputs = {
  ...
  filtered_domains = ["license.form.io", "secure.login.gov", ".raw.githubusercontent.com", ".identitysandbox.gov", "api.sam.gov", ".twistlock.com", "pro.formview.io", "pdf-dev.service.forms.gov", ".amazonaws.com"]
}
