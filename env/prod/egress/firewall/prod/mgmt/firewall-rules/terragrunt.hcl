...
inputs = {
  ...
  filtered_domains = [ "arsenal.us-gov-west-1.amazonaws.com","objects.githubusercontent.com",".twistlock.com", ".github.com", ".releases.hashicorp.com", ".repo.mongodb.org", ".registry.terraform.io", "amazon-ssm-packages-us-gov-west-1.s3.us-gov-east-1.amazonaws.com", ".checkpoint-api.hashicorp.com", "iam.us-gov.amazonaws.com", "ec2-instance-connect.us-gov-west-1.amazonaws.com"]
}
