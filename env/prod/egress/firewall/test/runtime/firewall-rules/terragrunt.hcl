...
dependencies      { paths = [ "../../../../../../test/runtime/vpc" ] }
dependency "vpc"  { config_path = "../../../../../../test/runtime/vpc" }
...
inputs = {
  ...
  filtered_domains = [ "portal-test.forms.gov", "license.form.io", ".raw.githubusercontent.com", "api.sam.gov", ".twistlock.com", "pro.formview.io", "amazon-ssm-packages-us-gov-west-1.s3.us-gov-east-1.amazonaws.com"]
}
